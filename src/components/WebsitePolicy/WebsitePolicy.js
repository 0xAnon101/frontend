  ...
  render() {
    return (
      <div className="main-container">
        ...
        <br/><br/>
        <h4>Legal basis for processing in the EU  </h4>
        ...
        <h4>Customer Data </h4>
          ...
          <br/><br/>
        <h4>Users control over information</h4>
          <p><b>Profile Data Sharing</b> <br/>You may choose not to share information through the Service, in which case Influence may not be able to provide services to you.
             You may update your account information and preferences at any time inside your account </p>
          <p><b>Control communication preferences</b><br/>You can stop receiving promotional email communications from us by clicking on the
          ...
          <p><b>Modifying or deleting your information</b><br/>If there is any question about modifying, or deleting your information, you can contact us directly at our email support.  
